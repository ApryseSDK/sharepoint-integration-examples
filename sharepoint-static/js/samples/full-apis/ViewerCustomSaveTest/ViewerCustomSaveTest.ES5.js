  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Vt = function(t, n) {
          return Wt(t, (n = m(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Bt = function(t, n, r) {
      ...
      mt || ((B.f = Vt), (V.f = Bt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Vt, defineProperty: Bt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
        ...
        (t.exports = function(t, n, r, e) {
          ...
          m
            ...
            : (u(function() {
              ...
              J(b !== Function.prototype ? P(y).concat(P(b)) : P(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: M }), g)) for (m in b) m in O || i(O, m, b[m]);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var E = String(m[0]), O = a(s(u(m.index), h.length), 0), F = [], P = 1; P < m.length; P++) F.push(void 0 === (x = m[P]) ? x : String(x));
            var M = m.groups;
            if (p) {
