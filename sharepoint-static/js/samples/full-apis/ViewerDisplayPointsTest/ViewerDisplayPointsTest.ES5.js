          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (p = Pt(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, g, d) {
      ...
      if (
        ...
        if (((m = { values: _ ? M : S('values'), keys: g ? M : S('keys'), entries: F }), d)) for (b in m) b in P || i(P, b, m[b]);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                E = a(m, v ? p : p.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === x) S = u(p, S, g);
              else {
                        ...
                        y = (function() {
                          var t = e(
                            regeneratorRuntime.mark(function t(n, r, e, o) {
                              var u, c, a, f, l, p, h, y, g, d, m, b, x, S, w, _, E;
                              return regeneratorRuntime.wrap(function(t) {
                                for (;;)
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                    ...
                                    case 28:
                                      return (x = t.sent), (t.next = 31), v(o, x.x, x.y);
                                    case 31:
                                      return t.abrupt('break', 97);
                                    case 32:
                                      return (a = r[u]), ++u, (f = r[u]), ++u, (t.next = 38), e.mult(a, f);
                                    case 38:
                                      return (x = t.sent), (t.next = 41), v(o, x.x, x.y);
                                    case 41:
                                      return t.abrupt('break', 97);
                                    case 42:
                                      return (a = r[u]), ++u, (f = r[u]), ++u, (l = r[u]), ++u, (p = r[u]), ++u, (h = r[u]), ++u, (y = r[u]), ++u, (t.next = 56), e.mult(h, y);
                                    case 56:
                                      return (x = t.sent), (t.next = 59), v(o, x.x, x.y);
                                    case 59:
                                      return t.abrupt('break', 97);
                                    case 60:
                                      return (a = r[u]), ++u, (f = r[u]), ++u, (m = r[u]), ++u, (b = r[u]), ++u, (p = f), (h = l = a + m), (g = a), (d = y = f + b), (t.next = 76), e.mult(a, f);
                                    case 76:
                                ...
                                function(e) {
                                  for (;;)
                                    switch ((e.prev = e.next)) {
                                      ...
                                      case 21:
                                        if (((s = e.sent), void 0 !== (b = u[o]))) {
                                          e.next = 34;
                                          break;
                                        }
                                        return (e.next = 26), c.getPage(o);
                                      case 26:
                                        return (y = e.sent), (x = new i.OCGContext(n)), h.beginOnPage(y, x), (e.next = 31), d(h);
                                      case 31:
                                        (b = e.sent), (u[o] = b), h.end();
                                      case 34:
                                        return (e.next = 36), c.getPage(o);
                                      case 36:
                                        return (y = e.sent), (x = new i.OCGContext(n)), (e.next = 40), g(b, v, c, y, o, s, a);
                                      case 40:
