!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Ct),
        h(Vt, yt, Ct.values),
        v(Vt, { slice: Rt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: kt }),
        It(Vt, 'buffer', 'b'),
        It(Vt, 'byteOffset', 'o'),
        It(Vt, 'byteLength', 'l'),
        It(Vt, 'length', 'e'),
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, D) || T(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = N(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(G, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (a(
        (k = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(V, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = f(s(u(b.index), p.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (h) {
              var A = [E].concat(O, P, p);
              void 0 !== M && A.push(M);
              var I = String(n.apply(void 0, A));
            } else I = y(E, p, P, O, M, n);
        ...
        return (
          ...
          (E.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: P(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), l;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    ((u = i(
      regeneratorRuntime.mark(function t(n) {
        var e, o, u, c, a, f, s, l, p, h, v, y, d, g, m, b, x, S, w, _;
        return regeneratorRuntime.wrap(function(t) {
          for (;;)
            switch ((t.prev = t.next)) {
              case 0:
                return (e = n.Core), (o = n.Core.PDFNet), e.setWorkerPath('../../../lib/core'), e.enableFullPDF(), (t.next = 6), o.initialize();
              case 6:
                (u = window.parent.window.document),
                  (c = e.initPDFWorkerTransports('pdf', {}, void 0)),
                  (a = ['viewer1', 'viewer2']),
                  (f = []),
                  (s = ['/samples/files/semantic_test_doc_1.pdf', '/samples/files/semantic_test_doc_2.pdf']),
                  (l = null),
                  (p = null),
                  (h = function(t) {
                    return new Promise(function(n) {
                      WebViewer({ path: '../../../lib', workerTransportPromise: c, fullAPI: !0 }, document.getElementById(t)).then(function(t) {
                        t.Core.syncNamespaces({ PDFNet: o }),
                            ...
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (
                                  ...
                                  (e = s.map(function(t) {
                                    return o.PDFDoc.createFromURL(t);
                                  })),
                                  (t.next = 4),
                                  Promise.all([].concat(r(n), r(e)))
                                );
                              case 4:
                                return (t.next = 6), Promise.all(e);
                              case 6:
                                return (c = t.sent), (t.next = 9), b(c[0], c[1]);
                              case 9:
                                      ...
                                      regeneratorRuntime.mark(function t() {
                                        ...
                                        return regeneratorRuntime.wrap(function(t) {
                                          for (;;)
                                            switch ((t.prev = t.next)) {
                                              case 0:
                                                return (n = v[0]), (r = v[1]), S(), (t.next = 5), b(n, r);
                                              case 5:
                                              case 'end':
                                                return t.stop();
                                            }
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 2:
                                return (e = t.sent), (t.next = 5), r.getPageCount();
                              case 5:
                                return (i = t.sent), (t.next = 8), o.PDFDoc.create();
                              case 8:
                                return (c = t.sent).lock(), (t.next = 12), o.PDFDoc.create();
                              case 12:
                                return (a = t.sent).lock(), (t.next = 16), o.PDFDoc.create();
                              case 16:
                                return (s = t.sent).lock(), (t.next = 20), s.appendTextDiffDoc(n, r);
                              case 20:
                                return (t.next = 22), s.getPageCount();
                              case 22:
                                (l = t.sent), (p = e > i), (h = e > i ? e : i), (d = 0);
                              case 26:
                                if (!(d < l)) {
                                  t.next = 49;
                                  break;
                                }
                                return (t.next = 29), s.getPage(d + 1);
                              case 29:
                                if (((g = t.sent), d !== h)) {
                                  t.next = 39;
                                  break;
                                ...
                                return (t.next = 34), c.pagePushBack(g);
                              case 34:
                                t.next = 38;
                                break;
                              case 36:
                                return (t.next = 38), a.pagePushBack(g);
                              case 38:
                              ...
                              case 39:
                                ...
                                return (t.next = 42), c.pagePushBack(g);
                              case 42:
                                t.next = 46;
                                break;
                              case 44:
                                return (t.next = 46), a.pagePushBack(g);
                              case 46:
                                d++, (t.next = 26);
                                break;
                              case 49:
                                return (t.next = 51), s.unlock();
                              case 51:
                                return (t.next = 53), c.unlock();
                              case 53:
                                return (t.next = 55), a.unlock();
                              case 55:
                                if ((f[0].UI.loadDocument(c), f[1].UI.loadDocument(a), y.push([].concat(v)), 1 !== y.length)) {
                                  t.next = 60;
                                  break;
                                }
                                return t.abrupt('return');
                              case 60:
                                (m = u.getElementById('recentFiles')),
                                  ((b = document.createElement('button')).innerText = 'Compare '.concat(n.fileName, ' (A) & ').concat(r.fileName, ' (B)')),
                                  b.classList.add('link'),
                                  (b.onclick = _.bind({ idx: y.length - 1 })),
                                  m.appendChild(b);
                              case 66:
                              case 'end':
                                return t.stop();
                      ...
                      regeneratorRuntime.mark(function t(n, r) {
                        ...
                        return regeneratorRuntime.wrap(function(t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), e.createDocument(n, {});
                              case 2:
                                return (o = t.sent), (t.next = 5), o.getPDFDoc();
                              case 5:
                                (v[r] = t.sent), (v[r].fileName = n.name), null !== v[1] && null !== v[0] && x();
                              case 8:
                              case 'end':
                                return t.stop();
                            }
                        ...
                        return regeneratorRuntime.wrap(
                          function(t) {
                            for (;;)
                              switch ((t.prev = t.next)) {
                                case 0:
                                  return (t.next = 2), b(y[this.idx][0], y[this.idx][1]);
                                case 2:
                                case 'end':
                                  return t.stop();
                              }
