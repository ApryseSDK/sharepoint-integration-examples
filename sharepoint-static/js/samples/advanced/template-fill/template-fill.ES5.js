        ...
        kt = {
          ...
          subarray: function(t, n) {
            var e = Pt(this),
              r = e.length,
              o = m(t, r);
            return new (N(e, e[mt]))(e.buffer, e.byteOffset + o * e.BYTES_PER_ELEMENT, d((void 0 === n ? r : m(n, r)) - o));
          },
        },
        Lt = function(t, n) {
    ...
    var o = e(1),
      ...
      J = function(t, n, e) {
        return (
          ...
          (n = _(n, !0)),
          b(e),
          i(V, n) ? (e.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (e = O(e, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), Y(t, n, e)) : T(t, n, e)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, e = N(w(t)), r = [], o = 0; e.length > o; ) i(V, (n = e[o++])) || n == C || n == f || r.push(n);
        return r;
      },
      nt = function(t) {
        for (var n, e = t === G, r = N(e ? U : w(t)), o = [], u = 0; r.length > u; ) !i(V, (n = r[u++])) || (e && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(e) {
              this === G && n.call(U, e), i(this, C) && i(this[C], t) && (this[C][t] = !1), Y(this, t, E(1, e));
            };
          return u && q && Y(G, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      for (var e in t) {
        ...
        switch (((n[e] = o), (o.propertyOrder = r.docOrder), r.typeId)) {
          ...
          case 'TemplateSchemaObject':
            (o.$ref = '#/definitions/template-object'), (o.properties = b(r.properties));
            break;
          case 'TemplateSchemaLoop':
            var i = new Set(r.loopType);
            (o.$ref = i.has('tableRow') && 1 === i.size ? '#/definitions/template-row-loop' : '#/definitions/template-loop'), (o.items = { title: e, properties: b(r.itemSchema) });
        }
      }
      return n;
    }
            ...
            return regeneratorRuntime.wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return w(), (n.next = 3), t.loadDocument(d[m] || m, { officeOptions: { doTemplatePrep: !0 }, onError: x });
                  case 3:
                  case 'end':
                    return n.stop();
                }
              ...
              return regeneratorRuntime.wrap(function(e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 2:
                      return (r = e.sent), (i = { $ref: '#/definitions/template-schema', properties: b(r.keys), definitions: O }), (e.next = 6), M(t);
                    case 6:
